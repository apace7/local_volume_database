...
comb_dwarf_mw.write('data_output/dwarf_mw.csv', format='csv', overwrite=True)
comb_dwarf_m31.write('data_output/dwarf_m31.csv', format='csv',overwrite=True)
comb_dwarf_lf.write('data_output/dwarf_local_field.csv', format='csv',overwrite=True)

comb_gc_disk.write('data_output/gc_disk.csv', format='csv',overwrite=True)
comb_gc_harris.write('data_output/gc_harris.csv', format='csv',overwrite=True)
comb_gc_ufsc.write('data_output/gc_ufsc.csv', format='csv',overwrite=True)

# comb_gc_ufsc.write('data_output/gc_ufsc.dat', format='ascii', overwrite=True)
# comb_gc_ufsc.write('data_output/gc_ufsc.mrt', format='ascii.mrt', overwrite=True)

comb_dwarf_mw.write('data_output/dwarf_mw.fits', format='fits', overwrite=True)
comb_dwarf_m31.write('data_output/dwarf_m31.fits', format='fits', overwrite=True)
comb_dwarf_lf.write('data_output/dwarf_local_field.fits', format='fits', overwrite=True)

comb_gc_disk.write('data_output/gc_disk.fits', format='fits', overwrite=True)
comb_gc_harris.write('data_output/gc_harris.fits', format='fits', overwrite=True)
comb_gc_ufsc.write('data_output/gc_ufsc.fits', format='fits', overwrite=True)
